...
4 - To run a training algorithm simply hit run
5 - Test cases can be viewed in the res folder and selectected for training in package mannySandhu.neuroevolution.tce/MlgData.java
